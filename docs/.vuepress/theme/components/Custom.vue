<template>
  <div class="container">
    ...
    <div class="head-social">
      <a href="https://github.com/hrf-666" target="_blank" class="head-social-btn">
        <icon name="grommet-icons:github" />
      </a>
      <router-link to="/blog/" class="head-social-avatar"><img src="/avatar.jpg" alt="avatar"></router-link>
      <a href="https://gitee.com/huang-ruifang" target="_blank" class="head-social-btn">
    ...
    <div class="about-me">
      <div class="card-content grid-row-3-2">
        ...
        <AboutMeText>
          <template #motto>
            <slot name="motto">
              <p class="about-me-card-title-normal">人生格言</p>
              <p class="about-me-card-text-big">狂野</p>
              <p class="about-me-card-text-big about-me-card-text-color">养成良好的习惯</p>
            </slot>
          </template>
        </AboutMeText>
      </div>
