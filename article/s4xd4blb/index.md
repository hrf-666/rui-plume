---
url: /rui-plume/article/s4xd4blb/index.md
---
# 解决ssh报错，.ssh/id\_rsa: No such file or directory Permission denied (publickey）
...
如果目录下面没有id\_rsa、id\_rsa.pub则表示key不存在
...
Key是第二步生成的 id\_rsa.pub文件 的内容全部复制到此处(id\_rsa.pub默认在C:\Users\Administrator.ssh目录下)。
...
## 老遇到开代理时，push时会报kex\_exchange\_identification
