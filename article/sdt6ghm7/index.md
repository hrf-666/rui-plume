---
url: /rui-plume/article/sdt6ghm7/index.md
---
\[\[toc]]
...
要注意其中的 start\_url和scope，如果你使用的是 GitHub 或者 Gitee 仓库的 Pages 服务，并且地址上带了仓库名，你需要将这里的learn-typescript-test替换为你的仓库名，如果是直接的域名，start\_url 写成  \，scope写成 .或者直接不写。
