---
url: /rui-plume/study-notes/back-end/java/x4ed04rn/index.md
---
\[\[toc]]
...
* MAXIMUM\_CAPACITY = 1 << 30，这个是临界范围，也就是最⼤的Map集合。
...
> 临界值（threshold ）= 默认容量（DEFAULT\_INITIAL\_CAPACITY） \* 默认扩容因子（DEFAULT\_LOAD\_FACTOR）
