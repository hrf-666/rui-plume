---
url: /rui-plume/study-notes/back-end/redis/b1989979/index.md
---
# 主节点异常情况
...
$\textcolor{red}{Master-Slave切换后，master\_redis.conf、slave\_redis.conf、sentinel.conf的内容都会发生改\变，即master\_redis.conf中会多一行slaveof的配置，而升级为master的主机会去掉原来的slaveof配置，\sentinel.conf的监控目标会随之调换}$
